package com.example.administrator.zuber.view;
...
public class SeekBarPressure extends View {
	...
	private String money[] = { "0", "500", "1000", "15000", "2000","2500","3000","3500","不限制"};
    /*
    ...
    public SeekBarPressure(Context context, AttributeSet attrs, int defStyle) {
        ...
        mScollBarHeight = a.getLayoutDimension(R.styleable.SeekBarPressure_myheight, "layout_height");
    ...
    protected void onDraw(Canvas canvas) {
       ...
       /* for (int i = 0; i < money.length; i++) {
        ...
        mScrollBarBgNormal.setBounds(0, 80, mScollBarWidth, mThumbHeight-40);
        mScrollBarBgNormal.draw(canvas);
        
        Log.d(TAG,mOffsetLow + 10-(mOffsetHigh + mThumbWidth-10)+"");
        mScrollBarProgress.setBounds(mOffsetLow + 20 , 80 , mOffsetHigh + mThumbWidth-10, mThumbHeight-40);
        mScrollBarProgress.draw(canvas);
        
        mThumbLow.setBounds(mOffsetLow+ 15, 50 , mOffsetLow  + mThumbWidth-5,   mThumbHeight-10);
        mThumbLow.draw(canvas);
        
        mThumbHigh.setBounds(mOffsetHigh+ 15, 50 , mOffsetHigh  + mThumbWidth-5, mThumbHeight-10);
